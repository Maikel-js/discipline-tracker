#!/bin/bash
# Genera paquete .deb desde linux-unpacked
set -e
...
# Crear postinst (despues de instalar)
...
# Crear prerm (antes de desinstalar)
...
# Generar paquete
dpkg-deb --build "$PKG_DIR" "dist/Discipline-Tracker-${VERSION}-Linux-amd64.deb"
